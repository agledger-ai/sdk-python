...
_SUGGESTIONS: dict[str, str] = {
    ...
    "CHAIN_EMPTY": (
        ...
        "correct and that the chain has not been truncated to zero rows."
    ),
    "CHAIN_POSITION_GAP": (
    ...
    "CHAIN_ALG_MISMATCH": (
        ...
        "trusted verification key can produce, or the key registry's declared algorithm "
        "contradicts the key material itself. Tamper class: the header alg or the key "
        "registry was rewritten. Treat the entry as forged; obtain the verification keys "
