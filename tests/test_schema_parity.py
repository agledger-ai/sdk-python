...
Snapshot lives with the TS SDK (single source for both languages) and is
regenerated by the weekly update-route-manifest workflow; skip cleanly when it
is unavailable (standalone checkout / PyPI install).
"""
